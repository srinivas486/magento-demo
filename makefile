...
MAKE_ENV += CUSTOMER_NAME BASE_DOMAIN DB_HOST DB_NAME DB_USER DB_PASS ADMIN_FIRST_NAME ADMIN_LAST_NAME ADMIN_USERNAME ADMIN_PASSWORD ADMIN_EMAIL CURRENCY LANGUAGE TIMEZONE BACKEND_FRONTNAME PACKAGE VERSION DOCKER_IMAGE DOCKER_IMAGE_DOMAIN DOCKER_IMAGE_DOMAIN_LOCALHOST REPLICAS
